view: fct_events {
  ...
  dimension: ip_address { type: string
  ...
  dimension: sk_event_date { type: string
    ...
    description: "Extracts the date part from the raw creation timestamp to represent the event date."
  }
